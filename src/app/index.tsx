...
const GAMES: GameItem[] = [
  ...
  { id: '2', title: 'Tetris', route: '/games/Tetris', icon: 'shape-square-plus' as IconName, color: Colors.dark.neonPurple, desc: 'Block Puzzle' }, { id: '3', title: '2048', route: '/games/2048', icon: 'format-list-numbered' as IconName, color: Colors.dark.accentGold, desc: 'Number Merge' },
